...
//  MiniSDL.h is provided to avoid the need of having SDL installed to 
//  recompile this example. Do not use it in your own programs, better
//  install and use the actual SDL library SDK.
#   define USE_MINI_SDL
#endif

#if defined USE_MINI_SDL
#   include "../src/MiniSDL.h"
#else
#   include <SDL/SDL.h>
#endif
...
int main()
{
    ...
    TwAddVarRW(bar, "Quit", TW_TYPE_BOOL32, &quit, 
               " label='Quit?' true='+' false='-' key='ESC' help='Click to quit.' ");
