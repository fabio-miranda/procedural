...
Square::Square(Vector3<float> position, float size) {
	...
	m_vboMesh->m_listVertex.push_back(*m_vertices[0]);
	m_vboMesh->m_listVertex.push_back(*m_vertices[1]);
	m_vboMesh->m_listVertex.push_back(*m_vertices[2]);
	m_vboMesh->m_listVertex.push_back(*m_vertices[3]);
	...
	*m_indices[3] = 3;
	...
	m_vboMesh->m_listIndex.push_back(*m_indices[0]);
	m_vboMesh->m_listIndex.push_back(*m_indices[1]);
	m_vboMesh->m_listIndex.push_back(*m_indices[2]);
	m_vboMesh->m_listIndex.push_back(*m_indices[3]);
