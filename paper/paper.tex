...
\title{Um Escalonador para Geração Procedural de Terrenos Pseudo-Infinitos em Tempo-Real Utilizando um Modelo CPU/GPU\\ou\\Um Escalonador para Geração Procedural de Terrenos Pseudo-Infinitos em Tempo-Real Utilizando Arquiteturas Heterogêneas GPU/CPU}
  ...
  \author{%
    {\IEEEauthorblockN{Authors Name/s per 1st Affiliation (Author)}
     \IEEEauthorblockA{line 1 (of Affiliation): dept. name of organization\\
      ...
      line 3: City, Country\\
      line 4: Web page: www.institution1.eud/~{}firstauthor}
     \and
