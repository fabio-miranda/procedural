...
\title{Um Escalonador para Geração Procedural de Terrenos Pseudo-Infinitos em Tempo-Real Utilizando Arquiteturas Heterogêneas GPU/CPU}
...
\iffinal
  \author
    {\IEEEauthorblockN{Fábio Markus N. Miranda, Luiz Chaimowicz}
