...
\title{Um Escalonador para Geração Procedural de Terrenos Pseudo-Infinitos em Tempo-Real utilizando um modelo CPU-GPU}
...
Ao final, uma discussão é feita com base em testes com três modelos de geração (CPU-only, GPU-only, GPU+CPU), com o objetivo de expor suas vantagens e desvantagens.
\end{abstract}

\begin{IEEEkeywords}
geração procedural; gpu; gpgpu;
\end{IEEEkeywords}
