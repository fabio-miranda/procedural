...
RenderingShader::RenderingShader(bool complex){
	...
	if(complex)
		LoadFiles("../../ProcTerrain/Shaders/complexTerrainRendering.vert", "../../ProcTerrain/Shaders/complexTerrainRendering.frag");
	else
		LoadFiles("../../ProcTerrain/Shaders/simpleTerrainRendering.vert", "../../ProcTerrain/Shaders/simpleTerrainRendering.frag");
