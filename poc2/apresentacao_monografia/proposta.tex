...
\begin{columns}
	\begin{column}{5cm}
	\begin{itemize}
		\item \alert<1-2>{Ruído de Perlin:\\} \onslide<1-2>{\scriptsize Função que retorna um valor com certa consistência com os outros valores ao seu redor.}
...
\begin{columns}
	...
	\begin{itemize}
		...
		\item \onslide<1> TerrainMng: gera e controla os terrenos.
	\end{itemize}
	\vspace{3cm} 
	\end{column}
	\begin{column}{5cm}
