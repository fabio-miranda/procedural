...
SquareNode::SquareNode(Vector3<float> position, float size, int num_divisions){
...
void SquareNode::GenerateNeighbours(SquareNode* m_oldNode){
	
	//TODO: Re-point the nodes from the oldNode to the new currentNode
	/*
	if(m_gridIndex == 1){
